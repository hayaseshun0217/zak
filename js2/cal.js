...
//calObj[0].daysClass["2018/12/29"] = 'haiso_kyugyo';
//calObj[0].daysClass["2018/12/30"] = 'haiso_nomi';
...
calObj[0].daysClass["3/20"] = 'Holyday';//;春分の日 2021
...
calObj[0].daysClass["8/9"] = 'Holyday';//;振替休日2021
calObj[0].daysClass["9/20"] = 'Holyday';//;敬老の日
calObj[0].daysClass["9/23"] = 'Holyday';//;秋分の日
calObj[0].daysClass["11/3"] = 'Holyday';//;文化の日
calObj[0].daysClass["11/23"] = 'Holyday';//;勤労感謝の日

calObj[0].daysClass["12/28"] = 'Holyday';//;年末年始
...
function cal_create(calId){
	...
	calHTML += "<input type='button' onclick='cal_move("+calId+",1);' value='来月 &gt;' />";
	calHTML += "</div>";
